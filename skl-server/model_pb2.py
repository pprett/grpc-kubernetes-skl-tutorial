...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='skl',
  syntax='proto3',
  serialized_pb=_b('\n\x0bmodel.proto\x12\x03skl\"\x1d\n\tModelSpec\x12\x10\n\x08model_id\x18\x01 \x01(\tB\x03\xf8\x01\x01\x62\x06proto3')
)
...
_MODELSPEC = _descriptor.Descriptor(
  name='ModelSpec',
  full_name='skl.ModelSpec',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='model_id', full_name='skl.ModelSpec.model_id', index=0,
...
ModelSpec = _reflection.GeneratedProtocolMessageType('ModelSpec', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:skl.ModelSpec)
  ))
